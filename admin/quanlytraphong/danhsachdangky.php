...
<table class="table table-hover m-auto text-center" style="font-size: 13px;">
	<thead class="badge-info">
		<tr>
			<th>Mã Đăng Ký</th> <th>Mã Sinh Viên</th><th>Mã Phòng</th><th>Ngày Đăng Ký</th><th>Ngày Trả Phòng</th><th>Tình trạng</th><th>Chi Tiết</th><th colspan ="2" class="badge-danger">Chức Năng</th>
		</tr>
	</thead>
	<tbody>
 <?php $so=0;
	 while ($row=mysqli_fetch_array($rs)) {
		...
		<tr>
			...
			<td><a href="index.php?action=quanlytraphong&view=chitietdangky&madk=<?php echo $row['MaDK']; ?>" >Chi tiết </a></td>
			<td><a href="quanlytraphong/xuly.php?action=duyet&madk=<?php echo  $row['MaDK']?>" >Duyệt </a></td>
