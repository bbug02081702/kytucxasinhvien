...
?>
		...
		<thead>
			<tr>
				<th>Mã NV</th><th>Họ Tên</th><th>Ngày Sinh</th><th>Địa Chỉ</th><th>SĐT</th><th>Quyền</th><th colspan="2">Chức năng</th>
			</tr>
		</thead>
		<tbody>
			<?php while ($row=mysqli_fetch_array($rs)) {?>
				...
				<tr>
					...
					<td><a href="quanlynhanvien/xuly.php?action=xoa&manv=<?php echo $row['MaNV'] ?>"></a></td>
				</tr>
				</form>	
	<?php	} ?>
