...
<table class="table table-hover m-auto text-center" style="font-size: 13px;">
	<thead class="badge-info">
		<tr>
			<th>Mã Đăng Ký</th> <th>Mã Sinh Viên</th><th>Mã Nhân Viên</th><th>Mã Phòng</th><th>Ngày Đăng Ký</th><th>Tình trạng</th><th>Chi Tiết</th><th>Xóa</th>
		</tr>
	</thead>
	<tbody>
 <?php $so=0;
	 while ($row=mysqli_fetch_array($rs)) {
		...
		<tr>
			...
			<td><a href="index.php?action=quanlydangkyphong&view=chitietdangky&madk=<?php echo $row['MaDK']; ?>" >Chi tiết </a></td>
			<td><a href="quanlydangkyphong/xuly.php?action=xoa&mdk<?php echo $row['MaDK']; ?>" >Xóa</a></td>
			<!-- <td><a href="quanlykhu/xuly.php?action=xoa&mp=<?php echo $row['MaKhu']; ?>" ><i class="fas fa-backspace"></i>Xóa</a></td> -->
