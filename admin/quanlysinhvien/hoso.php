...
?>
		...
		<thead>
			<tr>
				<th>MãSV</th><th>Họ Tên</th><th>Ngày Sinh</th><th>Giới Tính</th><th>Địa Chỉ</th><th>SĐT</th><th colspan="2">Chức năng</th>
			</tr>
		</thead>
		<tbody>
			<?php while ($row=mysqli_fetch_array($rs)) {?>
				...
				<tr>
					...
					<td><input  class="btn-sm btn-success btn" type="submit" name="action" value="Xóa"></td>
					<td><a href="quanlysinhvien/xuly.php?action=xoa&masv=<?php echo $row['MaSV'] ?>"></a></td>
				</tr>
				</form>	
	<?php	} ?>
