...
<table class="table table-hover text-center " style="font-size: 90%">
	<thead class="badge-info">
		<tr>
			<th>Mã Phòng</th><th>Mã Khu</th><th>Số Người Tối Đa</th><th>Số Người đang ở</th><th>Giá</th><th colspan ="3" class="badge-danger">Chức năng</th>
		</tr>
	</thead>
<?php
	$makhu=$row['MaKhu'];
...
?>
	<tbody>
		<tr>
			...
			<td><a href="quanlyphong/xuly.php?action=xoa&mp=<?php echo $row1['MaPhong']; ?>" >Xóa</a></td>
		</tr>
	</tbody>
<?php }?>
</table>
